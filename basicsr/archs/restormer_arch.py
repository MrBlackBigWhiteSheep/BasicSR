"""Restormer architecture ported from Restormer repo.
Requires dependency: einops
"""
import numbers
...
class Restormer(nn.Module):
    ...
    def __init__(self,
        ...
        self.refinement = nn.Sequential(*[TransformerBlock(dim=int(dim * 2 ** 1), num_heads=heads[0],
                                                           ffn_expansion_factor=ffn_expansion_factor,
                                                           bias=bias, LayerNorm_type=LayerNorm_type)
